...
TIMER_DIR=Common/drivers/LuminaryMicro

CFLAGS+=-I hw_include -I . -I ${RTOS_SOURCE_DIR}/include -I ${RTOS_SOURCE_DIR}/portable/GCC/ARM_CM3 -I ${TIMER_DIR} -I Common/include -D GCC_ARMCM3_LM3S102 -D inline=
CFLAGS+=-g
